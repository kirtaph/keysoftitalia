...
--
-- Host: localhost:3306
-- Creato il: Giu 10, 2026 alle 11:42
...
-- Database: `ks_site_db`
--
CREATE DATABASE IF NOT EXISTS `ks_site_db` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `ks_site_db`;
...
DROP TABLE IF EXISTS `dashboard_test_table`;
...
(1, 'Black Friday 2025', 'black-friday-2025', 'Sono arrivate le nostre offerte dedicate al Black Friday 2025', '2025-11-19', '2025-11-29', 1, 1, 'uploads/flyers/691b5fc4cf8ad-Black Friday 2025 (1).png', 'uploads/flyers/691b5fc4d080f-Black Friday 25 NEW.pdf', '', '2025-11-14 13:13:01', '2025-11-17 18:47:48'),
(2, 'Natale 2025', 'natale-2025', 'Volantino Offerte Natale 2025\r\nSmartphone, iPhone, Computer, Notebook, Tablet, Idee Regalo', '2025-12-16', '2025-12-31', 1, 1, 'uploads/flyers/694142068c986-Volantini NATALE 25.png', 'uploads/flyers/694142068cd64-NATALE 2025.pdf', '', '2025-12-16 12:27:02', '2025-12-16 12:27:02'),
(3, 'Promo Maggio 2026', 'promo-maggio-2026', 'Volantino Offerte Maggio 2026\r\nIdee Regalo, Smartphone, iPhone, iPhone Rigenerati, Smartwatch, Stampanti, Computer, Notebook, Offerte, Promozioni, Sconti', '2026-05-20', '2026-05-30', 1, 1, 'uploads/flyers/6a1167f3bf1aa-Volantini MAGGIO 2026.jpg', 'uploads/flyers/6a1167f3bf46b-Volantini MAGGIO 2026.pdf', '', '2026-05-23 10:40:19', '2026-05-23 10:40:19');
...
DROP TABLE IF EXISTS `ks_store_holidays`;
...
(10, 'fixed', 12, 26, 0, 'Santo Stefano', 1, 'Chiuso per festività', 1),
...
(13, 'fixed', 12, 25, 1, 'Natale', 1, NULL, 1);
...
DROP TABLE IF EXISTS `ks_store_hours_exceptions`;
...
(2, '2025-12-26', 1, '10:00:00', '13:00:00', 0, ''),
(12, '2025-12-31', 1, '09:00:00', '13:00:00', 0, ''),
(13, '2025-12-31', 2, NULL, NULL, 1, ''),
(14, '2025-12-21', 1, '10:00:00', '13:00:00', 0, ''),
(15, '2025-12-21', 2, NULL, NULL, 1, ''),
(16, '2025-12-18', 1, '09:00:00', '13:00:00', 0, ''),
(17, '2025-12-18', 2, '17:00:00', '20:30:00', 0, '');
...
DROP TABLE IF EXISTS `ks_store_hours_weekly`;
...
(1, '2025_11_28_002_dashboard_test.sql', '2025-11-28 19:48:12'),
(2, '2025_11_29_001_upgrade_used_quotes.sql', '2025-11-29 08:54:02');
...
(2, 1, 'iPhone 6 Plus', 1),
(3, 1, 'iPhone 6s', 1),
(4, 1, 'iPhone 6s Plus', 1),
(5, 1, 'iPhone SE (2016)', 1),
(6, 1, 'iPhone 7', 1),
(7, 1, 'iPhone 7 Plus', 1),
(8, 1, 'iPhone 8', 1),
(9, 1, 'iPhone 8 Plus', 1),
...
(11, 1, 'iPhone XR', 1),
(12, 1, 'iPhone XS', 1),
(13, 1, 'iPhone XS Max', 1),
(14, 1, 'iPhone 11', 1),
(15, 1, 'iPhone 11 Pro', 1),
(16, 1, 'iPhone 11 Pro Max', 1),
(17, 1, 'iPhone SE (2020)', 1),
(18, 1, 'iPhone SE (2022)', 1),
(19, 1, 'iPhone 12 mini', 1),
(20, 1, 'iPhone 12', 1),
(21, 1, 'iPhone 12 Pro', 1),
(22, 1, 'iPhone 12 Pro Max', 1),
(23, 1, 'iPhone 13 mini', 1),
(24, 1, 'iPhone 13', 1),
(25, 1, 'iPhone 13 Pro', 1),
(26, 1, 'iPhone 13 Pro Max', 1),
(27, 1, 'iPhone 14', 1),
(28, 1, 'iPhone 14 Plus', 1),
(29, 1, 'iPhone 14 Pro', 1),
(30, 1, 'iPhone 14 Pro Max', 1),
(31, 1, 'iPhone 15', 1),
(32, 1, 'iPhone 15 Plus', 1),
(33, 1, 'iPhone 15 Pro', 1),
(34, 1, 'iPhone 15 Pro Max', 1),
(35, 1, 'iPhone 16', 1),
(36, 1, 'iPhone 16e', 1),
(37, 1, 'iPhone 16 Plus', 1),
(38, 1, 'iPhone 16 Pro', 1),
(39, 1, 'iPhone 16 Pro Max', 1),
(40, 1, 'iPhone 17', 1),
(41, 1, 'iPhone 17 Pro', 1),
(42, 1, 'iPhone 17 Pro Max', 1),
(43, 1, 'iPhone Air', 1),
(44, 1, 'iPhone SE (3ª gen)', 1),
(45, 1, 'iPhone SE (2ª gen)', 1),
(47, 2, 'Galaxy S24 Ultra', 1),
(48, 2, 'Galaxy S24+', 1),
(49, 2, 'Galaxy S24', 1),
(50, 2, 'Galaxy S23 Ultra', 1),
(51, 2, 'Galaxy S23+', 1),
(52, 2, 'Galaxy S23', 1),
(53, 2, 'Galaxy S23 FE', 1),
(54, 2, 'Galaxy S22 Ultra', 1),
(55, 2, 'Galaxy S22+', 1),
(56, 2, 'Galaxy S22', 1),
(57, 2, 'Galaxy S21 Ultra', 1),
(58, 2, 'Galaxy S21+', 1),
(59, 2, 'Galaxy S21', 1),
(60, 2, 'Galaxy S21 FE', 1),
(61, 2, 'Galaxy S20 Ultra', 1),
(62, 2, 'Galaxy S20+', 1),
(63, 2, 'Galaxy S20', 1),
(64, 2, 'Galaxy A55', 1),
(65, 2, 'Galaxy A54', 1),
...
(70, 2, 'Galaxy A15', 1),
(71, 2, 'Galaxy A14', 1),
(72, 2, 'Galaxy Z Fold5', 1),
(73, 2, 'Galaxy Z Flip5', 1),
(74, 2, 'Galaxy Z Fold4', 1),
(75, 2, 'Galaxy Z Flip4', 1),
(76, 2, 'Galaxy Z Fold3', 1),
(77, 2, 'Galaxy Z Flip3', 1),
(78, 2, 'Galaxy Note 20 Ultra', 1),
(79, 2, 'Galaxy Note 20', 1),
(80, 2, 'Galaxy Note 10+', 1),
(81, 2, 'Galaxy Note 10', 1),
(110, 64, 'PlayStation 5 Slim', 1),
(111, 64, 'PlayStation 5', 1),
(112, 64, 'PlayStation 5 Digital Edition', 1),
(113, 64, 'PS4 Pro', 1),
(114, 64, 'PS4 Slim', 1),
(115, 64, 'PlayStation 4', 1),
(117, 65, 'Xbox Series X', 1),
(118, 65, 'Xbox Series S', 1),
(119, 65, 'Xbox One X', 1),
(120, 65, 'Xbox One S', 1),
(121, 65, 'Xbox One', 1),
(124, 66, 'Switch OLED', 1),
(125, 66, 'Switch', 1),
(126, 66, 'Switch Lite', 1),
(127, 56, 'Surface Pro 10', 1),
(128, 56, 'Surface Pro 9', 1),
(129, 56, 'Surface Pro 8', 1),
(130, 56, 'Surface Pro 7+', 1),
(131, 56, 'Surface Pro 7', 1),
(132, 56, 'Surface Pro X', 1),
(133, 56, 'Surface Go 4', 1),
(134, 56, 'Surface Go 3', 1),
(135, 56, 'Surface Go 2', 1),
(136, 56, 'Surface Laptop Studio 2', 1),
(137, 56, 'Surface Laptop Studio', 1),
(142, 2, 'Galaxy S9 (SM-G960F)', 1),
(143, 2, 'Galaxy A16', 1);
...
(2, 20, '', 'Nero', 128, 'A+', 419.00, 379.00, 'iPhone 12 128GB', '♻️RIGENERATO GRADO A+\r\n🔋Batteria Garantita >80%\r\n⚙️ Primo Avvio e configurazione \r\n↔️ Trasferimento Dati da vecchio Smartphone INCLUSO', 1, 1, '2025-11-14 10:00:46', '2026-03-21 09:42:52'),
(8, 143, 'GALAXYA16/128', '', 128, NULL, 199.00, 149.00, 'Galaxy A16 128GB ', 'Specifiche:\r\n- Modello: Samsung - Galaxy A16\r\n- Colori disponibili: Nero, Verde, Silver\r\n- Display: Super AMOLED, 90Hz\r\n- Fotocamera: Tripla 50MP + 5MP + 2MP\r\n- Selfie camera: 13 MP\r\n- Ram: 4GB\r\n- Memoria: 128 GB\r\n- Rete: 4G LTE\r\n- Condizioni: Nuovo\r\n\r\nCos\'è INCLUSO nel tuo Acquisto:\r\n- Primo Avvio e Configurazione Account\r\n- Passaggio dati da vecchio Smartphone\r\n- Recupero Credenziali App e Social', 1, 1, '2026-02-04 19:17:24', '2026-05-23 09:29:12'),
(9, 24, 'IPHONE13/128/BLACK', 'Nero', 128, 'A+', 499.00, 449.00, 'iPhone 13', '♻️RIGENERATO GRADO A+\r\n🔋Batteria Garantita >80%\r\n⚙️ Primo Avvio e configurazione\r\n↔️ Trasferimento Dati da vecchio Smartphone INCLUSO', 1, 1, '2026-03-21 09:21:22', '2026-03-21 09:43:06'),
(10, 27, 'IPHONE14/128', 'Nero', 128, 'A+', 579.00, 499.00, 'iPhone 14 Batteria 100%', '♻️RIGENERATO GRADO A+\r\n🔋Batteria Garantita 100%\r\n⚙️ Primo Avvio e configurazione\r\n↔️ Trasferimento Dati da vecchio Smartphone INCLUSO', 1, 1, '2026-03-21 17:12:24', '2026-03-21 17:12:24'),
(11, 131, 'RIG/SURFACEPRO7', 'Midnight Black', 256, 'A', 699.00, 599.00, 'Microsoft Surface - Surface Pro 7 256GB Midnight Black - Grado A', 'La potenza di un Computer e la comodità di un Tablet in unico prodotto\r\nScopri il Microsoft Surface Pro 7 con Tastiera Cover INCLUSA\r\n        \r\nSpecifiche Tecniche:\r\n- Modello: Microsoft Surface Pro 7\r\n- Processore: Intel Core i5 (10th)\r\n- RAM: 8 GB\r\n- Memoria: 256 GB SSD\r\n- S.O.: Windows 11 PRO\r\n- Colore: Midnight Black\r\n- Accessori: Alimentatore Rete + Tastiera Cover\r\n- Condizioni: ♻️RIGENERATO GRADO A (Testato e Funzionante al 100%)\r\n\r\n🧑‍🔧SERVIZI INCLUSI\r\n⚙️ Primo Avvio e configurazione\r\n💻 Aggiornamento S.O. e installazione Software\r\n↔️ Trasferimento Dati da vecchio Pc\r\n🏅 Garanzia 12 mesi', 1, 1, '2026-06-05 11:08:04', '2026-06-05 17:55:29');
...
(2, 2, 'assets/img/recond/6916fdcea42de-iphone 12 GRADO A.jpg', NULL, 0, 1),
(4, 8, 'assets/img/recond/698463e891131-Galaxy A16Front.png', NULL, 2, 0),
(10, 8, 'assets/img/recond/698464401d969-Galaxy A16Black.png', NULL, 1, 0),
(13, 8, 'assets/img/recond/69846a2b14bfe-Galaxy A16Silver.png', NULL, 0, 1),
(18, 2, 'assets/img/recond/69870fe001de2-images.jpg', NULL, 1, 0),
(19, 9, 'assets/img/recond/69be63574b8e8-iphone 13.jpg', NULL, 0, 1),
(20, 2, 'assets/img/recond/69be681c662ec-iphone 13.jpg', NULL, 0, 0),
(21, 9, 'assets/img/recond/69be682ab0a4c-iphone 13.jpg', NULL, 0, 0),
(22, 10, 'assets/img/recond/69bed1782a07f-iPhone 14.jpg', NULL, 0, 1),
(23, 11, 'assets/img/recond/6a22ae14e85c8-Surface1.png', NULL, 0, 1),
(24, 11, 'assets/img/recond/6a22ae14e90a6-surface2.png', NULL, 1, 0),
(25, 11, 'assets/img/recond/6a22ae14e9bbd-surface3.png', NULL, 2, 0),
(26, 11, 'assets/img/recond/6a22ae14ea2be-Surface4.png', NULL, 3, 0),
(27, 11, 'assets/img/recond/6a22ae14ea868-Surface5.jpg', NULL, 4, 0);
...
(2, '2025-12-13 08:19:24', 1, 'Xiaomi', 'Xiaomi 12t Pro', '[\"Batteria\"]', 'Dura poco', NULL, NULL, 59.00, NULL, 'Antonio', 'Oliverio', 'aoliverio79@gmail.com', '3498350676', NULL, 0xa29e740d, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', 'pending', NULL),
(3, '2025-12-15 06:57:22', 1, 'ZTE Blade a-34', 'smartphone android', '[\"Display rotto\",\"Microfono\"]', 'Mi è caduto e si è rotto il display e man mano che lo tengo così ora neanche il microfono x i msg vocali funziona', NULL, NULL, 117.00, NULL, 'Emilia', 'Dell\'Orco', 'emiliadellorco8@gmail.com', '3288847721', NULL, 0xa29e740d, 'Mozilla/5.0 (Linux; Android 13; ZTE Blade A34 Build/TP1A.220624.014) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.7444.171 Mobile Safari/537.36', 'pending', NULL),
(4, '2026-01-13 17:14:47', 1, 'Apple', 'iPhone 15 Pro', '[\"Display rotto\",\"Back Cover\\/Scocca\"]', NULL, NULL, NULL, 458.00, NULL, 'Patrizio', 'Cuscito', 'patrizio.cuscito@gmail.com', '3339938918', NULL, 0xa29e740d, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', 'pending', NULL),
(5, '2026-02-20 17:28:19', 6, 'asus', 'matherboard rampage III extreme', '[\"Altro\"]', 'Non si accende', NULL, NULL, 0.00, 0.00, 'Antonio', 'Alfano', 'antonioalfano2019@libero.it', '3755492882', NULL, 0x5d2f28f8, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36', 'pending', NULL),
(6, '2026-03-03 05:56:32', 1, 'Nothing phone', '2', '[\"Display rotto\"]', NULL, NULL, NULL, 69.00, NULL, 'Tommaso', 'Nuzzi', 'tommaso.nuzzi@gmail.com', '+393476845537', NULL, 0x5d92aa98, 'Mozilla/5.0 (Linux; Android 16; A065 Build/BQ2A.250721.001-BP2A.250605.031.A3; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/145.0.7632.113 Mobile Safari/537.36 Instagram 418.0.0.51.77 Android (36/16; 420dpi; 1080x2412; Nothing; A065; Pong', 'pending', NULL);
...
(2, 'keysoftitalia', '$2y$12$vOQp69vyYJgjxHlF4WDwYus7CLuany8S13grizImzS5XTll/ZYUbW', 'info@keysoftitalia.it', '2025-11-03 18:12:49');
